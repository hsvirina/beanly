        ...
        <div class="relative flex flex-col gap-[4px]">
          ...
          <div class="relative">
            <input
              ...
              placeholder="{{
                'AUTH.CONFIRM_PASSWORD_PLACEHOLDER' | translate
              }}"
            ...
            <button
              *ngIf="repeatPassword"
              ...
              tabindex="-1"
              [attr.aria-label]="
                'AUTH.TOGGLE_REPEAT_PASSWORD_VISIBILITY' | translate
              "
              class="absolute right-0 top-0 flex h-full w-[60px] items-center justify-center"
            >
              <app-icon
...
export class AuthPasswordStepComponent {
  ...
  get isPasswordMismatch(): boolean {
    return (
      this.repeatPassword.length > 0 && this.password !== this.repeatPassword
    );
  }
}
