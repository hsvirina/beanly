...
@Component({
  ...
  template: `
    <!-- Mobile layout -->
    <div
      class="relative flex h-[356px] w-full flex-col items-center justify-center xxl:hidden"
    >
      <app-icon
...
export class ImageCollageComponent {
  ...
  getZIndex(index: number): number {
    const photoNumber = index + 1;  // Photo numbering for custom z-index layering
