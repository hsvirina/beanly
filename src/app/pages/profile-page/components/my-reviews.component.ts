...
import { PublicReview } from '../../../shared/models/review.model';
...
import { BadgeType } from '../../../shared/utils/badge-utils';
                ...
                >
                  ...
                  <div class="flex items-center gap-3">
                    <div class="relative mr-2 h-[50px] w-[50px]">
                      ...
                      <img
                        [src]="userPhotoUrl"
                        alt="User photo"
                        class="absolute left-1/2 top-1/2 h-[44px] w-[44px] -translate-x-1/2 -translate-y-1/2 rounded-full object-cover"
                      />
                    </div>
                  ...
                  <div
                    *ngIf="review.text; else noText"
                    ...
                    style="display: -webkit-box; -webkit-line-clamp: 6; -webkit-box-orient: vertical; word-break: break-word; height: 144px;"
                  >
                    {{ review.text }}
                  </div>
...
export class MyReviewsComponent implements OnInit, AfterViewInit {
  ...
  prevSlide(): void {
    this.currentSlide =
      this.currentSlide === 0
        ? Math.max(this.reviews.length - this.slidesToShow, 0)
        : this.currentSlide - 1;
  }

  nextSlide(): void {
    this.currentSlide =
      this.currentSlide >= this.reviews.length - this.slidesToShow
        ? 0
        : this.currentSlide + 1;
  }
}
